...
export default function VisitTimeline({
  ...
  return (
    <div className="relative pl-3 pb-4">
        {/* 垂直参考线 */}
        <div className="absolute top-4 bottom-4 left-[1.625rem] w-[2px] bg-slate-200"></div>
        ...
        <div className="space-y-3 relative">
          ...
          return (
            ...
            >
              <div className="relative flex items-center justify-center w-4 h-4 z-10 bg-transparent mt-0.5">
                {active ? (
